      ...
      <>
            <div className="min-h-screen w-full bg-gray-200 text-white">
              ...
              <main className="max-w-7xl flex justify-center  pt-16 pb-10 lg:ml-30">
                  ...
                  <div className="bg-gradient-to-bl from-gray-700 to-blue bg-blue rounded-lg w-100 sm:w-200 h-190 md:h-140 ">
                      ...
                      <div className="form bg-gradient-to-l from-white to-gray-300 rounded-xl text-stone-900 mt-5 mx-4 pl-6 py-12 md:py-4 text-lg ">
                          ...
                          <div className="message mt-11 flex md:flex-row flex-col  text-sm md:text-xl "><label className='w-45 '>Reason for Reaching Out</label><input type="text" id='message' className='border-2  bg-white rounded-lg w-80   text-center h-30 p-2 text-dark ml-3' placeholder='Drop Message Here' /></div>
